...
Redux are applyed as ProductAction and ProductReducer, not ProductMyAction and ProductMyReducer


Don't forget npm add or yarn add @babel/plugin-proposal-nullish-coalescing-operator
